...
<html lang="en">
    ...
    <head>
        ...
        <title>Unifirst | Company Dashboard</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header">
                    <div>
                        <h2 class="hk-pg-title font-weight-600">Company Dashboard</h2>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                                ...
                                <div class="card card-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between position-relative">
                                            <div>
                                                <span class="d-block display-5 font-weight-400 text-dark"><%=res1.getString("postcount")%></span>
                                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                ...
                                <% String host3 = "jdbc:mysql://localhost:3306/unifirst";
                                    ...
                                    try {
                                        ...
                                        String data = "SELECT COUNT(problem.id) as problemcount FROM `problem` where universityID ='" + session.getAttribute("universityID") + "'";
                                        res3 = stat3.executeQuery(data);
                                        if (res3.first()) {
                                %>
                                <div class="card card-sm">
                                    <div class="card-body">
                                        <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">MY Total Problems</span>
                                        <div class="d-flex align-items-center justify-content-between position-relative">
                                            <div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                ...
                                <% String host4 = "jdbc:mysql://localhost:3306/unifirst";
                                    ...
                                    try {
                                        ...
                                        String data = "SELECT COUNT(requestlecture.id) as requestcount FROM `requestlecture`";
                                        res4 = stat4.executeQuery(data);
                                        if (res4.first()) {
                                %>
                                <div class="card card-sm">
                                    <div class="card-body">
                                        <span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Total Requests</span>
                                        <div class="d-flex align-items-center justify-content-between position-relative">
                                            <div>
                        ...
                        <c:forEach items="${dbSearch.getLastFiveEvent(sessionScope.universityID)}" var="b"> 
