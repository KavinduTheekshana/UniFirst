...
<head>
    ...
    <title>Unifirst | Add Members</title>
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Add Members</h5>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form action="AddMemberServelet" method="get">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputuname_1" name="username" placeholder="Username" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail_1" name="address" placeholder="Address" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="exampleInputEmail_1" name="email" placeholder="Enter Email" required>
                                            </div>
                                        </div>
