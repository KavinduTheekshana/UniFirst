                    ...
                    <div class="row mb-25">
                        <div class="col-sm">
                            <div class="button-list">
                                <a href="EventDelete.jsp?delete=${b.getId() }" class="btn btn-icon btn-danger btn-icon-style-1"><span class="btn-icon-wrap"><i class="material-icons">delete</i></span></a>
                                <br>
                                <a href="EventEdit.jsp?edit=${b.getId() }" class="btn btn-icon btn-warning btn-icon-style-1"><span class="btn-icon-wrap"><i class="material-icons">settings</i></span></a>
                            </div>
                        </div>
                    </div>                               
                </div>
