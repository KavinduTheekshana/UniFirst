...
<body>
    ...
    <%}%>
        ...
        <div class="hk-pg-wrapper">
            ...
            <c:forEach items="${dbSearch.getAllRequest(sessionScope.universityID)}" var="b"> 
                    ...
                    <div class="row mb-25">
                        <div class="col-sm">
                            <div class="button-list">
                                <a href="RequestDelete.jsp?delete=${b.getId() }" class="btn btn-icon btn-danger btn-icon-style-1"><span class="btn-icon-wrap"><i class="material-icons">delete</i></span></a> 
                            </div>
                        </div>
                    </div>                               
                </div>
