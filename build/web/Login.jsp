                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/uni.jpg);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(dist/img/com.jpg);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form action="LoginServelet" method="post">
                                    ...
                                    <p class="mb-5 text-danger"><%if(null!=request.getAttribute("errorMessage"))
                                                                    {
                                                                        out.println(request.getAttribute("errorMessage"));
                                                                    }
                                                                %></p>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Email" type="email" name="txtEmail" required>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Password" type="password" name="txtPassword" required>
...
<!--                                    <div class="form-row">
                                    ...
                                    <p class="text-center">Do have an account yet? <a href="Signup.jsp">Sign Up</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
