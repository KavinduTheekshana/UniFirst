                            ...
                            <div class="table-wrap">
                                <table id="datable_1" class="table table-hover w-100 display pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${dbSearch.getAllusers(sessionScope.universityID)}" var="b">
                                        <tr>
                                            <td>${b.getUsername() }</td>
                                            <td>${b.getAddress() }</td>
                                            <td>${b.getEmail() }</td>
                                            ...
                                            <td>
                                                <c:set var = "Ststus" scope = "session" value = "${b.getStstus() }"/>
                                                <c:if test = "${Ststus=='2'}">
                                                    <a href="MemberUnblock.jsp?unblock=${b.getId() }" class="btn btn-icon btn-success btn-icon-style-1"><span class="btn-icon-wrap"><i class="material-icons">lock_open</i></span></a>
                                                </c:if>
                                                
                                                <c:if test = "${Ststus=='1'}">
                                                    <a href="MemberBlock.jsp?block=${b.getId() }" class="btn btn-icon btn-indigo  btn-icon-style-1"><span class="btn-icon-wrap"><i class="material-icons">lock</i></span></a>
                                                </c:if>
