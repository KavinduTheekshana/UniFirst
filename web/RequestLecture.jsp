        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Request Lectures</h5>
                            <!--<p class="mb-25">Add Student Accounts in Here use University Email Address</p>-->
                            
                            <% if(null!=request.getAttribute("RequestLectureSucess")){ %>
                                    <div class="alert alert-success">
                            <% out.println(request.getAttribute("RequestLectureSucess")); %>
                                    </div>            
                                <%}%>
                                
                            <div class="row">
                                <div class="col-sm">
                                    <form action="RequestLectureServelet" method="post" enctype="multipart/form-data">
                                        
                                        <br>
                                        
                                        <div class="form-group">
                                            <label class="control-label mb-10" for="exampleInputuname_1">Subject</label>
                                            <input class="form-control" id="address2" placeholder="Subject" name="subject" type="text">
                                        </div>
