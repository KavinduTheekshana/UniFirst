                                ...
                                <div class="col-sm">
                                    ...
                                    <form action="QueriesEditServelet" method="post" enctype="multipart/form-data">
                                        ...
                                        <%
                                            ...
                                            String data = "SELECT * FROM `queries` WHERE `id`='"+num+"'";
                                        ...
                                        <div class="form-group col-md-9">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputuname_1" name="queries" value="<%=res.getString("queries")%>" required>
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group mb-0">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea class="tinymce" name="description"><%=res.getString("description")%></textarea>
                                        </div>
