<%-- 
    Document   : Header
    Created on : Apr 23, 2019, 7:28:41 PM
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="<%= session.getAttribute("profilepic") %>" alt="user" class="avatar-img rounded-circle">
                                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        <a class="dropdown-item" href="Profile.jsp"><i class="dropdown-icon zmdi zmdi-account"></i><span>Profile</span></a>
<!--                        <a class="dropdown-item" href="#"><i class="dropdown-icon zmdi zmdi-card"></i><span>My balance</span></a>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="logout.jsp"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-row">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="CompanyDashboard.jsp" data-toggle="collapse" >
                            ...
                            <ul id="app_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="CompanyDashboard.jsp">Dashboard</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                          ...
                                          <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="StudentsQueries.jsp">Students Queries</a>
                                        </li>
                                        ...
                                        <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="SelectAcademicCalendar.jsp">Academic Calendar</a>
                                        </li>
