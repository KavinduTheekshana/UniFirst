	...
	<div class="hk-wrapper hk-horizontal-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block" src="dist/img/logonew.png" alt="brand" />
            </a>
                        ...
                        <div class="hk-row">
							<div class="col-lg-3 col-sm-6">
								<div class="card card-sm">
									<div class="card-body">
										<span class="d-block font-11 font-weight-500 text-dark text-uppercase mb-10">Pending to Approve</span>
